...
public class App {
    public static void main(String[] args) {
        ...
        // Crear contactos
        Contacto contacto1 = new Contacto("Laura", "Lala", "Conjunto bosque", "3127062992", "lau@gmail.com");
        Contacto contacto2 = new Contacto("Maria", "mari", "Barrio Kioskos", "317277881", "maria@gmail.com");
        Contacto contacto3 = new Contacto("Martin", "Papá", "Mi casa", "3156906745", "martinval@gmail.com");
        Contacto contacto4 = new Contacto("Jorge", "Tio España", "Madrid, España", "3156562497", "jorgeg@gmail.com");
        Contacto contacto5 = new Contacto("Pedro", "Amigo universidad", "Barrio los alamos", "3215948721", "pedrolastr@gmail.com");
        Contacto contacto6 = new Contacto("Jose Antonio", "Toño", "Conjunto violetas", "3006498828", "tonito@gmail.com");
        Contacto contacto7 = new Contacto("Rosa Maria", "Abuela", "Mi casa", "3124856612", "rosita@gmail.com");
        Contacto contacto8 = new Contacto("Manuel", "Amigo Universidad", "Conjunto monteverde", "3144230806", "ahdmanuel@gmail.com");
        Contacto contacto9 = new Contacto("Saray", "Amiga colegio", "Barrio granada", "3214576420", "sarayqr@gmail.com");
        Contacto contacto10 = new Contacto("Mariana", "Amiga universidad", "Barrio los alamos", "3204485678", "mariana521@gmail.com");
        Contacto contacto11 = new Contacto("Michelle", "Amiga universidad", "Barrio campestre", "3154896241", "mich0928@gmail.com");
